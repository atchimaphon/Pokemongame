...
public void describe_items(){
    ...
    System.out.println("Pikachu : Attack 50 damage");
    System.out.println("Armor : protect your body");
}
public  int hp_potion(Pokemon hppotion){
...
public  void sp_potion(Pokemon hppotion){
...
public void use_potion(Pokemon usehp){
